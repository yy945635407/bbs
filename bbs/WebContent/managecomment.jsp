	...
	$.ajax({
		...
		success:function(result){
			...
			if(result.info=="yes"){//展示查询结果
				var htm = "<div class='row'><div class='col-md-6'>评论内容</div>" +
				"<div class='col-md-6'>操作</div></div>";
				var comments = result.comments;
				$.each(comments, function(i, comment){
					htm += "<div class='row'><div id='post' class='col-md-6'>"+ comment.content +
					"</div><div class='col-md-3'><a href='QueryPostByID?postID="+ comment.postID+"'>"+ "<button class='btn btn-default' type='submit'>进入帖子</button></a>" +
					"</div><div class='col-md-3'><a href='DeleteCommentServlet?commentID="+ comment.commentID +
					"'><button class='btn btn-default' type='submit'>删除</button></a></div></div>"
