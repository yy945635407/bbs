...
<style>
    ...
    #post{
      ...
      border: 1px solid rgba(96, 9, 226, 0.2);
      border-radius: 5px;
    }
</style>
<script>
...
function search(dir,first){
	...
	//alert(keyWord);
	$.ajax({
		url:"QueryPostServlet",
		data:{"keyWord":keyWord, "currentPage":currentPage, "pageSize":pageSize},
		type:"post",
		dataType:"json",
		success:function(result){
			...
			if(result.info=="yes"){//展示查询结果
				...
				$.each(posts, function(i, post){
					htm += "<div class='row'><div id='post' class='col-md-12'><a href='QueryPostByID?postID=" +
...
<div class="container">
	<!-- <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	 ...
	 <div class="row">
	 	<div class="col-md-8"><input type="text" id="key" class="form-control" name="keyWord" placeholder="请输入要搜索的内容" required autofocus/></div>
	 	<div class="col-md-2"></div>
	 	<div class="col-md-2"><button class="btn btn-md btn-primary btn-block" type="submit" onclick="search(0,1);">搜索帖子</button></div>
	 </div>
