	...
	$.ajax({
		...
		success:function(result){
			...
			if(result.info=="yes"){//展示查询结果
				var htm = "<div class='row'><div class='col-md-6'>标题</div><div class='col-md-4'>审核情况</div>" +
				"<div class='col-md-2'>操作</div></div>";
				var posts = result.posts;
				$.each(posts, function(i, post){
					var status = "未过审";//审核状态
					if(post.reviewed=="1") status = "已过审";
					htm += "<div class='row'><div id='post' class='col-md-6'><a href='QueryPostByID?postID="+ post.postID +"'>"+ post.title +
					"</a></div><div class='col-md-4'>" + status + "</div>"+
					"<div class='col-md-2'><a href='DeletePostServlet?postID="+ post.postID +
